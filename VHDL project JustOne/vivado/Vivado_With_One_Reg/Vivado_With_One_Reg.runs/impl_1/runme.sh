...
HD_PWD='C:/Users/david/Desktop/Rasla_Davide_505828/VHDL project JustOne/vivado/Vivado_With_One_Reg/Vivado_With_One_Reg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ConvolutionalGenerator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ConvolutionalGenerator.tcl -notrace
